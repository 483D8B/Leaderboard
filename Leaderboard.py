...
response = requests.post('https://483d8b.pythonanywhere.com/addScore', headers={'Content-Type': 'application/json'}, data=json.dumps([{"country": entry["element"], "points": entry["points"], "league": "1"} for entry in entries]))
